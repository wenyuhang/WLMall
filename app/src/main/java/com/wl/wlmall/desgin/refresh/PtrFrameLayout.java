...
//                }
    ...
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof in.srain.cube.views.ptr.PtrFrameLayout.LayoutParams;
    }

    @Override
    protected ViewGroup.LayoutParams generateDefaultLayoutParams() {
        return new in.srain.cube.views.ptr.PtrFrameLayout.LayoutParams(in.srain.cube.views.ptr.PtrFrameLayout.LayoutParams.MATCH_PARENT, in.srain.cube.views.ptr.PtrFrameLayout.LayoutParams.MATCH_PARENT);
    }

    @Override
    protected ViewGroup.LayoutParams generateLayoutParams(ViewGroup.LayoutParams p) {
        return new in.srain.cube.views.ptr.PtrFrameLayout.LayoutParams(p);
    }

    @Override
    public ViewGroup.LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new in.srain.cube.views.ptr.PtrFrameLayout.LayoutParams(getContext(), attrs);
    }
