...
public class FollowListAdapter extends BaseQuickAdapter<FollowListBean.DataBean.RecordsBean, BaseViewHolder> {
    ...
    public FollowListAdapter(Context context, List<FollowListBean.DataBean.RecordsBean> data) {
        super(R.layout.recy_news_item, data);
        this.context = context;
    }

    @Override
    protected void convert(BaseViewHolder helper, final FollowListBean.DataBean.RecordsBean item) {
